...
func (mg *ObjectStore) ResolveReferences( // ResolveReferences of this ObjectStore.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("storage.civo.upbound.io", "v1beta1", "ObjectStoreCredential", "ObjectStoreCredentialList")
		if err != nil {
...
func (mg *VolumeAttachment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.civo.upbound.io", "v1beta1", "Instance", "InstanceList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("storage.civo.upbound.io", "v1beta1", "Volume", "VolumeList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
