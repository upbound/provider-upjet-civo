...
type ObjectStoreInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-civo/apis/cluster/storage/v1beta1.ObjectStoreCredential
	...
	AccessKeyIDRef *v2.Reference `json:"accessKeyIdRef,omitempty" tf:"-"`

	// Selector for a ObjectStoreCredential in storage to populate accessKeyId.
	// +kubebuilder:validation:Optional
	AccessKeyIDSelector *v2.Selector `json:"accessKeyIdSelector,omitempty" tf:"-"`
